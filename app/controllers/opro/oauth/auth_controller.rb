class Opro::Oauth::AuthController < OproController
  ...
  private def user_granted_access_before?(user, params)
    @client_app ||= Opro::Oauth::ClientApp.find_by_app_id(params[:client_id])
  ...
  private def scope_from_params(params)
